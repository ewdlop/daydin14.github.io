                ...
                <div className="flex flex-row items-center justify-center mb-8">
                    ...
                    <div className="flex flex-col ml-4">
                        ...
                        <div className="flex space-x-4 mt-4">
                            <a href="https://github.com/daydin14" target="_blank" rel="noopener noreferrer" className='mr-2 tooltip transition-transform transform hover:scale-125' data-tip='GitHub Profile'>
                            ...
                            <a href="https://www.linkedin.com/in/daydin14" target="_blank" rel="noopener noreferrer" className='mr-2 tooltip transition-transform transform hover:scale-125' data-tip='LinkedIn Profile'>
